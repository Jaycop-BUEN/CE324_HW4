...
function showGrids() {
	...
	Coordinates.drawAxes({axisLength:11.05,axisOrientation:"x",axisRadius:0.02});
	Coordinates.drawAxes({axisLength:11.05,axisOrientation:"y",axisRadius:0.02});
}
function addToDOM() {
...
try {
  ...
  var material = new THREE.MeshBasicMaterial( { color: 0xC45FF6, side: THREE.FrontSide } );
